...
- 🧪 Building **[agent-eval](https://github.com/sauravbhattacharya001/agent-eval)** — zero-dependency TypeScript toolkit for evaluating AI agent outputs three ways: eval framework, fleet monitoring, and a CI quality gate
...
| **[agent-eval](https://github.com/sauravbhattacharya001/agent-eval)** ⭐ 2 | Zero-dependency TypeScript toolkit for evaluating AI agent outputs — three pillars: an eval framework (3-tier assertion pyramid with hallucination/drift/staleness checks), fleet monitoring (score transcripts, track trends, health scorecard), and a CI quality gate (block a GitHub Action on empty/stale/off-task/contradictory output). | [![tests](https://img.shields.io/badge/tests-1432+-brightgreen?style=flat)](https://github.com/sauravbhattacharya001/agent-eval) | — |
...
| **[WinSentinel Pro](https://github.com/sauravbhattacharya001/winsentinel-pro)** | Pro tier — license server, fleet management, advanced modules for enterprise deployment. | [![Pro](https://img.shields.io/badge/tier-Pro-gold?style=flat)](https://github.com/sauravbhattacharya001/winsentinel-pro) | [🌐 Site](https://sauravbhattacharya001.github.io/winsentinel-site/) |
