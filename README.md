...
![Releases](https://img.shields.io/badge/Releases-16-green?style=flat-square)
...
| **[OCaml Samples](https://github.com/sauravbhattacharya001/Ocaml-sample-code)** | 17-module functional programming collection — data structures (BST, trie, hashmap, bloom filter, red-black trees, union-find, heap), algorithms (sorting, graph, regex via Thompson's NFA), and more. | [![v1.0.0](https://img.shields.io/badge/release-v1.0.0-blue?style=flat)](https://github.com/sauravbhattacharya001/Ocaml-sample-code/releases/tag/v1.0.0) | [📄 Site](https://sauravbhattacharya001.github.io/Ocaml-sample-code/) |
